...
timeout -k 5s 5s ./bitree "value=input31.txt;command=command31.txt;output=output31.txt" 1>1.stdcout 2>1.stderr
...
timeout -k 5s 5s ./bitree value=input32.txt command=command32.txt output=output32.txt 1>1.stdcout 2>1.stderr
...
# For test case 3
timeout -k 5s 5s ./bitree "value=input33.txt;command=command33.txt;output=output33.txt" 1>1.stdcout 2>1.stderr
